...
public class EnteringNormalCtrl : MonoBehaviour
{
    ...
    string[] titles = new string[]{
        ...
        "发票金额","信用证金额","余额","起息日","到期日","宽限期","天数","利率","手续费率","ftp",
        "综合利率","净收入率","利息","手续费","费用合计","经营净收入","贴现金额","成交价格",
        "开证日期","有效期"
    };
    ...
    void Start()
    {
        ...
        {
            _enteringItemCtrl.Add(EnteringItemCtrl.Show(grid, titles[i]));
        }
    }
    ...
    public void OnClickEntering(){
        ExcelTool.WritExcelOneRow("Assets/Resources/Excel/FFT_all.xlsx", 30, indexs, GetAllInputVals());
    }
}
